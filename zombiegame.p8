...
function uplayer()
 ...
 for h in all(herbs) do
  if col(h,player) and
     player.hp<100 then
   --pick up ammo
   del(herbs,h)
   if player.hp+h.value>100 then
    player.hp=100
   else
    player.hp+=h.value
   end
...

